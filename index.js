...
const QuizHandler={
  ...
  async handle(handlerInput) 
  {
    ...
    return handlerInput.responseBuilder
    .speak("Sorry something seems off. If you want to take a quiz of 10 questions, just say give me a quiz with 10 numbers ")
    .withShouldEndSession(false)
    .getResponse();
   }
...
const ReviseHandler={
  ...
  async handle(handlerInput) {
    ...
    return handlerInput.responseBuilder
    .speak("Sorry something seems off. If you want to revise 10 easy questions, just say i want to revise 10 numbers ")
    .withShouldEndSession(false)
    .getResponse();
   }

    console.log(" revise yaha 3");
...
const FallbackHandler ={
  ...
  handle(handlerInput) {
    return handlerInput.responseBuilder
      .speak(" If you want help then you can say I need help")
      .reprompt(" If you want help then you can say I need help")
      .getResponse();
  },
};
...
const ErrorHandler = {
  ...
  handle(handlerInput, error) {
    console.log("yaha error hai" +handlerInput.requestEnvelope.request.intent.name);
...
function diffArray (array)
 {
   console.log("array input to begin: "+array);
    var len = begin(array);
    var diff = [];
...
function generateMediumQuestions (array,n) {
    ...
    console.log("i "+i+" easyarr "+easyarr);
